...
function createAnimations(animations) {
  ...
  return {
    ...
    useAnimatedNumber(initial) {
      ...
      const finishTimerRef = import_react2.default.useRef(null);
      return {
        getInstance() {
          return setVal;
        },
    ...
    useAnimations: /* @__PURE__ */ __name(({
      ...
      const wasEnteringRef = import_react2.default.useRef(isEntering);
      const justFinishedEntering = wasEnteringRef.current && !isEntering;
      import_react2.default.useEffect(() => {
        wasEnteringRef.current = isEntering;
      });
      const exitCycleIdRef = import_react2.default.useRef(0);
      const exitCompletedRef = import_react2.default.useRef(false);
      const wasExitingRef = import_react2.default.useRef(false);
      const exitInterruptedRef = import_react2.default.useRef(false);
...
var import_web3 = require("@tamagui/web");
